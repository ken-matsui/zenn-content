...
SPA ではない場合や、そもそもフロントエンドでない場合は、Firebase Hosting を使用できませんが、それに対してもプレビューデプロイを実現できます。そちらに関する詳細は、[プレビューデプロイをCloud Runで行う](/articles/preview-deploy-on-cloud-run)にて紹介しています。
